...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieGVsZW0iLCJhIjoiY2wxdXhtNGhsMDNjMDNlcjFpbzkyZ3VreiJ9.R1hM3B-K8aVXHwHyctn6pg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/xelem/cl1vfvvhe000314msqn93ab2e',
    // style URL
    scrollZoom: false //   center: [-118.263464, 34.025852], // starting position [lng, lat]
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to includer current locatons
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " update was successful"));
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KrWZ4KIplwJBzUQtCZXn4dgJGYWe1Sr1LYDyNw7G3UKA5llSz2ApwIB9V2XF8YPzQnsuhASvRZdD7gZFftqqaQ800NIti5WqE');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            window.location.replace("".concat(session.data.session.url));
            _context.next = 13;
            break;
